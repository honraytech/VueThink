...
--
-- Host: localhost
-- Generation Time: Feb 24, 2017 at 04:34 PM
...
--
-- Database: `dev1480584355`
--

-- --------------------------------------------------------

--
-- Table structure for table `oa_admin_access`
--
...
--
-- Dumping data for table `oa_admin_access`
--
...
--
-- Table structure for table `oa_admin_menu`
--
...
CREATE TABLE IF NOT EXISTS `oa_admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='【配置】后台菜单表' AUTO_INCREMENT=71 ;

--
-- Dumping data for table `oa_admin_menu`
--
...
--
-- Table structure for table `oa_admin_post`
--
...
CREATE TABLE IF NOT EXISTS `oa_admin_post` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='岗位表' AUTO_INCREMENT=37 ;

--
-- Dumping data for table `oa_admin_post`
--
...
--
-- Table structure for table `oa_admin_structure`
--
...
--
-- Dumping data for table `oa_admin_structure`
--
...
--
-- Table structure for table `oa_admin_user`
--
...
--
-- Dumping data for table `oa_admin_user`
--
...
--
-- Table structure for table `oa_system_config`
--
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='【配置】系统配置表' AUTO_INCREMENT=5 ;

--
-- Dumping data for table `oa_system_config`
--
